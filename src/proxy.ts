...
// /api/calendar and /api/widget carry their own per-user token in the URL —
// the calendar app and the iOS widget can't send a session cookie.
const PUBLIC_PREFIXES = ["/api/auth", "/api/calendar", "/api/cron", "/api/widget"];
